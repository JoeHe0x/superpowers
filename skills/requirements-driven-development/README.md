...
- 标准场景使用 [`references/dd-template.md`](/Users/hefei/Code/rdd/skills/requirements-driven-development/references/dd-template.md)
- 低风险局部变更使用 [`references/lightweight-dd-template.md`](/Users/hefei/Code/rdd/skills/requirements-driven-development/references/lightweight-dd-template.md)
- 需求到测试映射可参考 [`references/traceability-examples.md`](/Users/hefei/Code/rdd/skills/requirements-driven-development/references/traceability-examples.md)
...
交接前建议检查 [`references/plan-and-test-handoff.md`](/Users/hefei/Code/rdd/skills/requirements-driven-development/references/plan-and-test-handoff.md)。
...
对于 Java Spring Boot Maven 项目，建议额外检查 [`references/springboot-maven-checklist.md`](/Users/hefei/Code/rdd/skills/requirements-driven-development/references/springboot-maven-checklist.md)。
